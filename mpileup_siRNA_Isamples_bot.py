...
if __name__ == "__main__":
	...
	"""
	#path = os.getcwd()
	path = "/mnt/scratch/baak009/bowtie/tomato_on_botrytis/overlap_reads_clean_bot_ref/"
	#path of directory with bam files
	#path = "/mnt/scratch/baak009/bowtie/unique_tomato/clean_t_r/"
	#dirs = os.listdir(path)
	dirs = os.listdir("/mnt/scratch/baak009/bowtie/tomato_on_botrytis/overlap_reads_clean_bot_ref/Isamples")
	counter = 1
	length = 18 # minumum length of selected piece 
	#cov = 3 # botrytis
	cov = 150# minimum number of reads 
	gap = 2
	print 'length',length, 'cov',cov, 'gap', gap
	file_name = 'merged_f_I_overlap.bam'
